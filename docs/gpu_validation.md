...
| `TORCH_VERSIONS` | `2.10 2.11 2.12 2.13 2.14` | Space-separated minor versions. |
| `BASELINE` | `2.10` | torch version used as the energy/force reference. |
